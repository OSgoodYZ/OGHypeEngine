...
//
//const OgVideoMode* lv_platform_common_choose_video_mode(OgMonitor* monitor, const OgVideoMode* desired);
//
...
//
//OgMonitor* lv_platform_common_alloc_monitor(const char* name, int widthMM, int heightMM);
//
//void og_platform_common_free_monitor(OgMonitor* monitor);
//
//void og_platform_common_input_monitor(LvSystemContext* sysCtx, OgMonitor* monitor, int action, int placement);
//
