...
void OgRenderContextVulkan::initRayTracingSupport()
{
    ...
    vkGetAccelerationStructureBuildSizesKHR = (PFN_vkGetAccelerationStructureBuildSizesKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkGetAccelerationStructureBuildSizesKHR");
    vkCreateAccelerationStructureKHR = (PFN_vkCreateAccelerationStructureKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkCreateAccelerationStructureKHR");
    vkDestroyAccelerationStructureKHR = (PFN_vkDestroyAccelerationStructureKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkDestroyAccelerationStructureKHR");
    vkGetAccelerationStructureDeviceAddressKHR = (PFN_vkGetAccelerationStructureDeviceAddressKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkGetAccelerationStructureDeviceAddressKHR");
    vkCmdBuildAccelerationStructuresKHR = (PFN_vkCmdBuildAccelerationStructuresKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkCmdBuildAccelerationStructuresKHR");
    vkBuildAccelerationStructuresKHR = (PFN_vkBuildAccelerationStructuresKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkBuildAccelerationStructuresKHR");
    vkCmdTraceRaysKHR = (PFN_vkCmdTraceRaysKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkCmdTraceRaysKHR");
    vkGetRayTracingShaderGroupHandlesKHR = (PFN_vkGetRayTracingShaderGroupHandlesKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkGetRayTracingShaderGroupHandlesKHR");
    vkCreateRayTracingPipelinesKHR = (PFN_vkCreateRayTracingPipelinesKHR)vkGetDeviceProcAddr(_logicalDeviceVK, "vkCreateRayTracingPipelinesKHR");
...
OgAccelStructureHandle* OgRenderContextVulkan::CreateAccelerationStructure(const OgAccelStructureBuildInfo& buildInfo)
{
    ...
    if (buildInfo.type == OgAccelStructureType::BOTTOM_LEVEL)
    {
        ...
        for (uint32 i = 0; i < buildInfo.bottomLevel.geometryCount; ++i)
        {
            ...
            if (geom.vertexBuffer)
            {
                ...
                vkGeom.geometry.triangles.vertexData.deviceAddress = vkGetBufferDeviceAddress(_logicalDeviceVK, &addressInfo);
            ...
            if (geom.indexBuffer)
            {
                ...
                vkGeom.geometry.triangles.indexData.deviceAddress = vkGetBufferDeviceAddress(_logicalDeviceVK, &addressInfo);
    ...
    else
    {
        ...
        if (buildInfo.topLevel.instanceBuffer)
        {
            ...
            vkGeom.geometry.instances.data.deviceAddress = vkGetBufferDeviceAddress(_logicalDeviceVK, &addressInfo);
        }
    ...
    vkGetAccelerationStructureBuildSizesKHR(_logicalDeviceVK, 
    ...
    createInfo.type = buildInfo.type == OgAccelStructureType::TOP_LEVEL ? 
        VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR : VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR;
    VK_CHECK_RESULT(vkCreateAccelerationStructureKHR(_logicalDeviceVK, &createInfo, nullptr, &accelStructure->accelStructure));
    
    // Get device address
    VkAccelerationStructureDeviceAddressInfoKHR addressInfo{};
    addressInfo.sType = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR;
    addressInfo.accelerationStructure = accelStructure->accelStructure;
    accelStructure->deviceAddress = vkGetAccelerationStructureDeviceAddressKHR(_logicalDeviceVK, &addressInfo);
    ...
    OgAccelStructureHandle* accelStructure, const OgAccelStructureBuildInfo& buildInfo)
{
    ...
    vkCmdBuildAccelerationStructuresKHR(encoderVK->cmdBufferVK, 1, &buildGeometryInfo, &pBuildRangeInfos);
}
...
OgPipelineHandle* OgRenderContextVulkan::CreateRayTracingPipeline(const OgRayTracingPipelineDescriptor& descriptor)
{
    ...
    VK_CHECK_RESULT(vkCreateRayTracingPipelinesKHR(_logicalDeviceVK, VK_NULL_HANDLE, VK_NULL_HANDLE, 
    ...
    const OgRayTracingShaderGroup* groups, uint32 groupCount)
{
    ...
    VK_CHECK_RESULT(vkGetRayTracingShaderGroupHandlesKHR(_logicalDeviceVK, rtPipeline->pipeline, 
