...
public:
	...
	static uint GetPixelCount(OgPixelFormat format)
	{
		...
		case OgPixelFormat::R32G32B32A32_SFLOAT:
			...
			// The Pixel Count of Depth Stencil Buffer will be 1 (����)
		case OgPixelFormat::D24_UNORM_S8_UINT:
		case OgPixelFormat::D32_SFLOAT_S8_UINT:
			return 1;
...
struct OG_API OgRenderPassInfo
{
	...
	/* TODO :	Subpass Desccription/Dependency Implementation
		Subpass ������ ������(VkSubpassDescription) �� �ٸ� Ŭ���� �ʿ�
...
struct OG_API OgFrameBufferHandle : OgHandle
{
	...
	OgFrameBufferInfo framebufferInfo;			// Offscreen Framebuffer�� ����

	// TODO: �۾��ϱ� ���� 21.11.07
	OgFrameBufferHandle();
	OgFrameBufferHandle(uint32 useDepthStencil, uint32  width, uint32 height);
	OgFrameBufferHandle(const OgFrameBufferInfo& info); // Offscreen FraameBuffer �� ������
...
struct OG_API OgResourceBinding
{
	...
	uint16					arrayCount;	// array�� �ƴ϶�� 0���� �����Ǿ�� �ϰ�, array([n])�̶�� 1 �̻����� �����Ǿ�� �Ѵ�.

	const char*				name;		// Uniform Texture Name / Assume name is a literal (name = "something"). GLES3 Platform�� ���� �׻� �����Ǿ�� �Ѵ�.
...
struct OG_API OgShaderDescriptor
{
	...
	OgShaderHandle*		shaders[2];	// @Chan : ���� Vertex/Fragment���� Geometry/Tesellation���� ���� �ȴٸ� �̰��� �� �ø��� �ȴ�.
	uint32				shaderCount;
...
struct OG_API OgCommandEncoderHandle : OgHandle
{
	...
	// Clear Color�� ���Ǵ� ���� ��� 0 ~ 1������ ������ ���� precision�� ����ص� �ȴ�.
	// ���� �־��� ��, type casting�� �ϸ�ȴ�.
	union ClearValue
	{
		struct
